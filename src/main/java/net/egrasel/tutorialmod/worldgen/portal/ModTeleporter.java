package net.egrasel.tutorialmod.worldgen.portal;

import net.egrasel.tutorialmod.block.ModBlocks;
import net.egrasel.tutorialmod.block.custom.ModPortalBlock;
import net.minecraftforge.common.util.ITeleporter;
import net.minecraft.core.BlockPos;
import net.minecraft.server.level.ServerLevel;
import net.minecraft.world.entity.Entity;
import net.minecraft.world.level.block.Blocks;
import net.minecraft.world.level.material.Fluids;;import java.util.function.Function;
