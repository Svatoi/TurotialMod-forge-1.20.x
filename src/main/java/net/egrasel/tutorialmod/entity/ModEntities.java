package net.egrasel.tutorialmod.entity;

import net.egrasel.tutorialmod.TutorialMod;
import net.egrasel.tutorialmod.entity.custom.DiceProjectileEntity;
import net.egrasel.tutorialmod.entity.custom.ModBoatEntity;
import net.egrasel.tutorialmod.entity.custom.ModChestBoatEntity;
