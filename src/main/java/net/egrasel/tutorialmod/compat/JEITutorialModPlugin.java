package net.egrasel.tutorialmod.compat;
...
import net.egrasel.tutorialmod.recipe.GemPolishingRecipe;
...
public class JEITutorialModPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(GemPolishingCategory.GEM_POLISHING_TYPE, polishingRecipeList);
    }
