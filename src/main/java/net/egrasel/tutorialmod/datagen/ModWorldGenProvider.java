...
import net.egrasel.tutorialmod.worldgen.ModConfiguredFeatures;
import net.egrasel.tutorialmod.worldgen.ModPlacedFeatures;
import net.egrasel.tutorialmod.worldgen.biome.ModBiomes;
import net.egrasel.tutorialmod.worldgen.dimension.ModDimensions;
